...
<table border="0" style="width: 120%;float: left;">
    ...
    if ($entered_needed_sets_pdf[0]['delivery_type_option'] == '1') {
        ...
        // create some HTML content
            ...
            $html_2 .= '<tr>';
            $html_2 .= '<td>RECIPIENT ' . $x . '</td>';
            $html_2 .= '</tr>';
            $html_2 .= '<tr>';
            $html_2 .= '<td style="height:15px;">&nbsp;</td>';
            $html_2 .= '</tr>';
            $html_2 .= '<tr>';
            $html_2 .= '<td style="font-weight: bold;">Send to: </td>';
            $html_2 .= '</tr>';
            $html_2 .= '<tr>';
            $html_2 .= '<td>';
            if (($entered_sets['shipp_id'] != 'P1') && ($entered_sets['shipp_id'] != 'P2')) {
                ...
                $html_2 .= $shipp_add[0]['company_name'] . '<br>' . 'Attention: ' . $entered_sets['attention_to'] . '<br>' . $tel . $shipp_add[0]['address_1'] . ',<br>' . $add_2 . $add_3 . $shipp_add[0]['city'] . ',&nbsp;' . StateName($shipp_add[0]['state']) . '&nbsp;' . $shipp_add[0]['zip'];
            $html_2 .= '</td>';
            } else {                    //echo $shipp_add[0]['address']; 
            $html_2 .= '<td>';
            $shipp_add_p = AddressBookPickupSohoCap($entered_sets['shipp_id']);
            $html_2 .= $shipp_add_p[0]['address'];
            $html_2 .= '</td>';
            }
            $html_2 .= '</tr>';
